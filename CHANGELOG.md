...
## [@planetlogin/core 0.9.0] — 2026-07-16 — self-serve sign-up
...
## [@planetlogin/core 0.7.0] — anonymous / guest sessions
...
- The token carries `anon: true` — it's a session identity, **not** authentication of a person. Consumers must treat it as unauthenticated for anything sensitive. Upgrade path: bind the `sub` to a real account later (uses the downstream). SPEC §3; config.schema; +4 tests (core 69).

## [@planetlogin/core 0.6.0] — in-process downstream
...
## [@planetlogin/core 0.5.0] — encrypted session tokens (JWE)
...
## [@planetlogin/core 0.4.0] — locale memory Tier 2 (account-bound)
...
Initial public release (as `@rricajos/planetpass`). Rebranded to `planetlogin` and
moved to `github.com/planetlogin` shortly after.
...
[@planetlogin/core 0.10.0]: https://github.com/planetlogin/planetlogin/compare/core-v0.9.0...core-v0.10.0
[@planetlogin/core 0.9.0]: https://github.com/planetlogin/planetlogin/compare/core-v0.7.0...core-v0.9.0
[@planetlogin/core 0.7.0]: https://github.com/planetlogin/planetlogin/compare/core-v0.6.0...core-v0.7.0
[@planetlogin/core 0.6.0]: https://github.com/planetlogin/planetlogin/compare/core-v0.5.0...core-v0.6.0
[@planetlogin/core 0.5.0]: https://github.com/planetlogin/planetlogin/compare/core-v0.4.0...core-v0.5.0
[@planetlogin/core 0.4.0]: https://github.com/planetlogin/planetlogin/compare/core-v0.2.0...core-v0.4.0
[@planetlogin/core 0.2.0]: https://github.com/planetlogin/planetlogin/compare/v0.1.2...core-v0.2.0
[@planetlogin/planetlogin 0.2.0]: https://github.com/planetlogin/planetlogin/compare/v0.1.2...planetlogin-v0.2.0
[0.1.2]: https://github.com/planetlogin/planetlogin/releases/tag/v0.1.2
[0.1.1]: https://github.com/planetlogin/planetlogin/releases/tag/v0.1.1
